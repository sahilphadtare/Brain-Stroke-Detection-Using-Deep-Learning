...
root.title("Brain Hemorrhage detection") 
...
#
lbl = tk.Label(root, text="Brain Hemorrhage detection", font=('times', 35,' bold '), width=65,height=1,bg="Red3",fg="white")
lbl.place(x=0, y=0)
...
def test_model_proc(fn):
    ...
    if fn!="":
        ...
        if yoga == 0:
            ...
            Cd="Epidural_Positive"
        elif yoga == 2:
           Cd="Subarachnoid_Positive"
...
def openimage():
    ...
    global fn
    print(fn)
    fileName = askopenfilename(initialdir='E:/project 2023/Brain hamorhage', title='Select image for Aanalysis ',
                               filetypes=[("all files", "*.*")])
    IMAGE_SIZE=200
    imgpath = fileName
    fn = fileName
