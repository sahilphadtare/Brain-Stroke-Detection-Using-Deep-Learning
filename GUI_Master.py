...
root.title( "Brain Hemorrhage Disease detection")
...
img2=ImageTk.PhotoImage(Image.open("7.jpg"))
...
#
label_l1 = tk.Label(root, text="Brain Hemorrhage Disease detection",font=("Times New Roman", 35, 'bold'),
...
button1 = tk.Button(root, text="Brain Hemorrhage Disease detection", command=reg, height=1,font=('times', 20, ' bold '), bg="#152238", fg="white")
